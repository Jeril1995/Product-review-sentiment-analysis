...
short_pos = open("short_reviews/IntegratedPros.txt","r",errors='ignore').read()
short_neg = open("short_reviews/IntegratedCons.txt","r",errors='ignore').read()
# move this up here
all_words = []
documents = []
...
for p in short_pos.split('\n'):
    ...
    for w in pos:
        if w[1][0] in allowed_word_types and w[1][1] in allowed_word_types2:
